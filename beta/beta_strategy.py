...
def m15_gold_strategy(data):
    ...
    data.loc[data['is_buy2'], 'tp'] = data['close'] + 5
    data.loc[data['is_buy2'], 'sl'] = data['close'] - 1
    data.loc[data['is_sell2'], 'tp'] = data['close'] - 5
    data.loc[data['is_sell2'], 'sl'] = data['close'] + 1
    ...
    #condition for setting new trailing stop
    data.loc[data['is_buy2'], 'be_condition'] = data['close'] + 1.2
    data.loc[data['is_sell2'], 'be_condition'] = data['close'] - 1.2
